              ...
              <li key={index}>
                <div className="book">
                  <div className="book-top">
                    <div className="book-cover" style={{ width: 128, height: 193, backgroundImage: ((element.imageLinks && element.imageLinks.thumbnail)?`url(${element.imageLinks.thumbnail})`:"none") }}></div>
